...
<html>
    <head>
        <meta lang="es" />
        <meta charset="utf-8" />
        <meta name="author" content="CableNaranja" />
        <meta name="description" content="Tutorial: Popup CSS sin JavaScript" />
        <meta name="keywords" content="Popup CSS, Popup sin JavaScript" />
        <title>Popup CSS sin JavaScript | CableNaranja</title>
	...
	$sql .= " date_at = \"".$_GET["date_at"]."\"";
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<!--a href="http://localhost:8085/calendario/calendar.php" class="btn btn-success btn-xs">Calendario</a-->
				
        		<a href="http://localhost:8085/calendario/calendar.php" target="popup" onclick="window.open('http://localhost:8085/calendario/calendar.php','popup','width=600,height=600'); return false;" class="btn btn-success btn-xs">Calendario</a>
				
				<!--
				<a href="#popup" class="btn btn-success btn-xs">Calendario</a>
