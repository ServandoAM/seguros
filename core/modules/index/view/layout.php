    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">GoldenAd-Agentes <sup><small><span class="label label-info">v1.2020</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          <li><a href="index.php?view=newreservation"><i class="fa fa-asterisk"></i>Evento Nuevo</a></li>
          </ul> 
          ...
          <li><a href="index.php?view=contacts"><i class="fa fa-male"></i> Ficha de Clientes</a></li>
          <?php if($u->is_admin):?>
          <li><a href="index.php?view=changelog"><i class="fa fa-filter"></i>M&oacute;dulos de Sistema </a></li>
